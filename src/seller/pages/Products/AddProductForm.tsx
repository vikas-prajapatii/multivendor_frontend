  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      const formattedRequest = {
        ...
        quantity: values.quantity ? Number(values.quantity) : 10,
      };
      dispatch(createProduct({ request: formattedRequest, jwt: localStorage.getItem("jwt") }));
      console.log("dispatching createProduct with payload:", formattedRequest);
    },
  });
